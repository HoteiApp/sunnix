...
type FormNewClient struct {
	...
	Newcasemanagement struct {
		Tcm    string `json:"tcm"`
		Status string `json:"status"`
		Doa    string `json:"doa"`
	} `json:"newCaseManagement"`
	NewCMSure struct {
		PlanName      string `json:"plan_name"`
		PlanID        string `json:"plan_id"`
		Auth          bool   `json:"auth"`
		...
		AuthUnit      int64  `json:"auth_unit"`
		TimeRange     int64  `json:"time_range"`
		Active        bool   `json:"active"`
	} `json:"newScmSure"`
	NewCMMedical struct {
		Scm               int    `json:"scm"`
		MedicalPcp        string `json:"reason"`
...
type FormRequestEditClient struct {
	Editclient struct {
		ID                int    `json:"id"`
		ReferringAgency   string `json:"referring_agency"`
		ReferringPerson   string `json:"referring_person"`
...
type FormRequestEditSure struct {
	Editsure struct {
		ID            int    `json:"id"`
		PlanName      string `json:"plan_name"`
		PlanID        string `json:"plan_id"`
...
type FormRequestSubmitSure struct {
	SubmnitSure struct {
		ID                int    `json:"id"`
		Scm               int    `json:"scm"`
		PlanName          string `json:"plan_name"`
...
type FormRequestAddSure struct {
	Addsure struct {
		ID            int    `json:"id"`
		PlanName      string `json:"plan_name"`
		PlanID        string `json:"plan_id"`
...
type FormEditCertification struct {
	Editcertification struct {
		Scm                int    `json:"scm"`
	...
	} `json:"editCertification"`
}

type FormEditAssessment struct {
	Editassessment struct {
		Scm                                    int    `json:"scm"`
		...
		SubstanceOtherspecify                  string `json:"substance_OtherSpecify"`
		...
		SubstanceOther1Specify                 string `json:"substance_Other1Specify"`
		...
		Recipent2                              string `json:"recipent2"`
...
type FormEditSp struct {
	Editsp struct {
		...
		Goal1BMet         bool   `json:"goal1bMet"`
		Goal1BNotMet      bool   `json:"goal1bNotMet"`
		Goal1BOngoing     bool   `json:"goal1bOngoing"`
		...
		Goal1CMet         bool   `json:"goal1cMet"`
		Goal1CNotMet      bool   `json:"goal1cNotMet"`
		Goal1COngoing     bool   `json:"goal1cOngoing"`
		...
		Goal1DMet         bool   `json:"goal1dMet"`
		Goal1DNotMet      bool   `json:"goal1dNotMet"`
		Goal1DOngoing     bool   `json:"goal1dOngoing"`
		...
		Goal1EMet         bool   `json:"goal1eMet"`
		Goal1ENotMet      bool   `json:"goal1eNotMet"`
		Goal1EOngoing     bool   `json:"goal1eOngoing"`
		...
		Goal2BMet         bool   `json:"goal2bMet"`
		Goal2BNotMet      bool   `json:"goal2bNotMet"`
		Goal2BOngoing     bool   `json:"goal2bOngoing"`
		...
		Goal2CMet         bool   `json:"goal2cMet"`
		Goal2CNotMet      bool   `json:"goal2cNotMet"`
		Goal2COngoing     bool   `json:"goal2cOngoing"`
		...
		Goal2D10NotMet      bool   `json:"goal2d10NotMet"`
		...
		Goal2D11Met         bool   `json:"goal2d11Met"`
		Goal2D11NotMet      bool   `json:"goal2d11NotMet"`
		Goal2D11Ongoing     bool   `json:"goal2d11Ongoing"`
		...
		Goal2D12Met         bool   `json:"goal2d12Met"`
		Goal2D12NotMet      bool   `json:"goal2d12NotMet"`
		Goal2D12Ongoing     bool   `json:"goal2d12Ongoing"`
		...
		Goal2D13Met         bool   `json:"goal2d13Met"`
		Goal2D13NotMet      bool   `json:"goal2d13NotMet"`
		Goal2D13Ongoing     bool   `json:"goal2d13Ongoing"`
		...
		Goal4BOngoing     bool   `json:"goal4bOngoing"`
		...
		Goal4DOngoing     bool   `json:"goal4dOngoing"`
		...
		Goal5AMet         bool   `json:"goal5aMet"`
		Goal5ANotMet      bool   `json:"goal5aNotMet"`
		Goal5AOngoing     bool   `json:"goal5aOngoing"`
		...
		Goal6A1Met         bool   `json:"goal6a1Met"`
		Goal6A1NotMet      bool   `json:"goal6a1NotMet"`
		Goal6A1Ongoing     bool   `json:"goal6a1Ongoing"`
		...
		Goal7AMet         bool   `json:"goal7aMet"`
		Goal7ANotMet      bool   `json:"goal7aNotMet"`
		Goal7AOngoing     bool   `json:"goal7aOngoing"`
		...
		Goal8AMet         bool   `json:"goal8aMet"`
		Goal8ANotMet      bool   `json:"goal8aNotMet"`
		Goal8AOngoing     bool   `json:"goal8aOngoing"`
