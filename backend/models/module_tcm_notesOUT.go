...
type NotesOut struct {
	...
	SignatureBILLER string `json:"biller_finance"`
	...
	SignatureBILLER2 string `json:"biller_finance2"`
	...
	SignatureBILLER3 string `json:"biller_finance3"`
	...
	SignatureFinance string `json:"signature_finance"`
	...
	SignatureFinance2 string `json:"signature_finance2"`
	...
	SignatureFinance3 string `json:"signature_finance3"`
}
