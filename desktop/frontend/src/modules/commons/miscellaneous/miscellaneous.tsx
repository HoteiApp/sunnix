...
const Miscellaneous = ({ active, scm, relad }: Props) => {
    ...
    const categorys: CategoryFile[] = [
        { name: 'Client\'s ID', code: 'ClientsID' },
        { name: 'Medicaid Card', code: 'Medicaid Card' },
        { name: 'Medicare Card', code: 'Medicare Card' },
        { name: 'Insurance Card', code: 'Insurance Card' },
        { name: 'PN Psych', code: 'PN Psych' },
        { name: 'PN PCP', code: 'PN PCP' },
                    ...
                    <div className="md:flex lg:flex w-full">
                        <div className="w-full md:w-2/4 lg:w-2/4">
                            <div className="w-full place-items-center">
                                <div className="grid flex-grow w-full pr-5">
                                    <div className='flex'>
                                        <div className='w-auto text-2xl tracking-tight place-items-center pt-1 pl-5 pr-5'>Category File:</div>
                        ...
                        <div className="w-full md:w-2/4 lg:w-2/4">
                            <div className="flex w-full place-items-center">
                                <div className="grid flex-grow w-full pr-5">
                                    <div className='flex'>
                                        <div className='w-auto text-2xl  tracking-tight place-items-center pt-1 pl-5 pr-5'>Date:</div>
                                ...
                                <div className="grid text-right">
                                    ...
                                    <div>
                                        {selectedCategory !== null && uploadButton}
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    const emptyTemplate = () => {
        return (
            selectedCategory !== null && date !== null &&
    ...
    const onUpload = () => {
        if (fileUploadRef.current) {
            ...
            if (file && date && selectedCategory) {
                ...
                const path = `clients-${scm?.Demografic.client_id.toString()}-${scm?.id.toString()}-misc-${selectedCategory.code}-${formatDate}`;
