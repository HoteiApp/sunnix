...
// ------
import { Active, Event, Fortnight } from "../../models";
// TODO New struct
...
const FinanceDashboard = ({ active, relad }: Props) => {
  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <Dialog header={dateSelect} maximizable visible={visible} modal={true} style={{ width: '60vw' }} onHide={() => setVisible(false)}>
        <DiaryBiller date={dateSelect} active={active} payments={payments} relad={relad} />
      </Dialog>
    </div>
  );
};
