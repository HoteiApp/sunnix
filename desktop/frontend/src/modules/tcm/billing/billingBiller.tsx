...
import { useModuleTcmAllTcms, useBillBusinessConfig, useTcmAddPayments, useBillUserConfig } from "../../../hooks/modules/tcm";
...
const BillingBiller = ({ active, relad }: Props) => {
    ...
    const { tcms, isLoading, reloadTCMS } = useModuleTcmAllTcms();
                            ...
                            let header = () => (
                                ...
                                >
                                    ...
                                    <b style={{ fontSize: "12px" }}>Billings</b>
                                        ...
                                        {(active?.activeUser?.User?.roll === "FINANCE" || active?.activeUser?.User?.roll === "QA") && (
                                            <div
                                                className='flex'
                                            ...
                                            >
                                                ...
                                                <i className='pi pi-dollar pay ml-5 cursor-pointer hover:text-orange-400 animate-bounce'
                                                    data-pr-tooltip="PayRoll"
                                                    data-pr-position="top"

                                                    onClick={() => {
                                                        setBusiness(tcms.info?.ID || "0");
                                                        setBusinessID(tcms.user?.business || "0");
                                                        setVisiblePayRollBuss(true);
                                                    }} />
                                            ...
                                            <p className="m-0 border-t">
                                                ...
                                                {(tcms.list_tcm?.length || 0) > 0 ? (
                                                    <div className='h-72'>
                                                        ...
                                                        <hr />
                                                        <div className='h-72 overflow-y-auto pr-4'>
                                                            {tcms.list_tcm?.map((tcm) => (
                                                                ...
                                                                >
                                                                    <div className='w-full flex'>
                                                                        ...
                                                                        <div className='w-4/6 truncate' title={tcm.info?.fullname}>
                                                                            {tcm.info?.fullname}
                                                                        </div>
                                                                        <div className='w-1/6 text-center'>
                                                                            {tcm.clients?.length}
                                                                        </div>
                                                                        <div className='w-1/6 text-center flex content-center place-content-center pt-1'>
                                                                            <Tooltip target=".pay" />

                                                                            <i className='pi pi-dollar pay ml-5 cursor-pointer hover:text-orange-400'
                                                                                data-pr-tooltip="PayRoll"
                                                                                data-pr-position="top"

                                                                                onClick={() => {
                                                                                    setBusiness(tcms.user?.business || "0");
                                                                            ...
                                                                            <i className='pi pi-cog options ml-5 cursor-pointer hover:text-orange-400 '
                                                                                ...
                                                                                onClick={() => {
                                                                                    ...
                                                                                    setTcm(tcm.info?.ID || "0");
                                                                                    setTcmData(tcm);
                                                                                    setFixedPay(!!tcm.user?.fixed_pay);
                                                                                    setPaymentRate(tcm.user?.payment_by_units || 0);
                                                                                }}
                                                                            />
                                                                        </div>
                                                                    </div>
