...
import { InputField } from "../../../modules/commons/forms/InputField";
...
const FaLogin = () => {
  ...
  // if (activeUser?.two_factor?.status === "FALSE") {
  //   navigate("/app/profile");
  // }
  return (
    <div className="flex items-center justify-center w-full h-full flex-col">
      <img src={logoLogin} className="w-24 mb-2" alt="" />
      <h1 className="mb-2">Autenticación en dos partes</h1>
      <div className="border-2 p-4 border-secondary rounded-lg w-4/5 lg:w-1/5 flex flex-col ">
        <FontAwesomeIcon icon={faMobilePhone} className="h-12  mb-4" />
        <Formik initialValues={{}} onSubmit={() => {}} enableReinitialize>
          <Form>
            <TwoFactorField field="fa" />
...
// const TwoFactor = () => {
//   const [inputTwoFactor, setTwoFactor] = useState("");
